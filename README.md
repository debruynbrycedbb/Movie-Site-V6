...
A personal film library — 300 films, rated out of 10, sorted however you like, with an
auto-ranked Top 25.
...
3. Select the 8 site files (everything ending in .html, .css or .js) and drop them in.
...
Name each file after the film's **id**. `POSTER-FILENAMES.txt` lists all 300 of them:
